...
class _ExNavigationState extends State<ExNavigation> {
  ...
  getNavigation() {
    ...
    var unselectedColor =
        widget.unselectedColor ?? Colors.green.withOpacity(0.4);
    ...
    return BottomNavigationBar(
      ...
      selectedItemColor: widget.selectedColor ?? Colors.green,
      unselectedItemColor: widget.unselectedColor ?? Colors.grey,
